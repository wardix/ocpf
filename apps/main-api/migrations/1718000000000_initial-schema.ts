...
export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.sql(`
    ...
    DROP TABLE IF EXISTS email_message_metadata CASCADE;
    ...
    DROP TABLE IF EXISTS chatbot_config_versions CASCADE;
    ...
    DROP TABLE IF EXISTS label_team_routing CASCADE;
    ...
    DROP TABLE IF EXISTS contact_merge_logs CASCADE;
    ...
    DROP TYPE IF EXISTS scheduled_message_status CASCADE;
